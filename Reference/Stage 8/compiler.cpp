...
{
       0,    67,    67,    76,    84,   106,   107,   109,   112,   113,
     115,   116,   119,   120,   123,   124,   126,   127,   128,   129,
     141,   155,   169,   170,   171,   172,   173,   174,   175,   176,
...
/* Line 1455 of yacc.c  */
#line 128 "compiler.y"
    {(yyval) = (yyvsp[(1) - (5)]); (yyval)->setPTR2((yyvsp[(3) - (5)]));deb;if((yyvsp[(3) - (5)])->getType()!=INTEGER){yyerror("Can print Integers only");return 1;};}
    break;
...
/* Line 1455 of yacc.c  */
#line 169 "compiler.y"
    {if(!assignExpression((yyval),(yyvsp[(1) - (3)]),(yyvsp[(2) - (3)]),(yyvsp[(3) - (3)])))	return 1;(yyval)->setType(INTEGER);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 174 "compiler.y"
    {if(!assignExpression((yyval),(yyvsp[(1) - (3)]),(yyvsp[(2) - (3)]),(yyvsp[(3) - (3)])))	return 1;(yyval)->setType(BOOLEAN);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 182 "compiler.y"
    {if(!assignExpression((yyval),(yyvsp[(1) - (2)]),(yyvsp[(2) - (2)]),nullptr))return 1;(yyval)->setType(BOOLEAN);;}
    break;
...
#line 189 "compiler.y"
    {
										if((yyvsp[(3) - (4)])->getType()!=INTEGER){yyerror("Index can be Integer only");return 1;}
										symbolNode *Table = currentScope->getTable(), *temp;
										temp = Table->lookUp((yyvsp[(1) - (4)])->getName());
										if(temp==nullptr){
											yyerror("'"+(yyvsp[(1) - (4)])->getName()+"' not Declared");
											return 1;
										}
										else if(temp->getSize()==-1){
											yyerror("'"+(yyvsp[(1) - (4)])->getName()+" used as Array but declared as Variable");
											return 1;
										}
										else{
...
#line 208 "compiler.y"
    {
										...
										if(temp==nullptr){
											yyerror("'"+(yyvsp[(1) - (1)])->getName()+"' not Declared");
											return 1;
										}
										else if(temp->getSize()!=-1){
											yyerror("'"+(yyvsp[(1) - (1)])->getName()+"' used as Variable but declared as Array");
											return 1;
										}
										else{
